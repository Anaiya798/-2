...
namespace ChemicalShopTests.DbTests
{
    ...
    internal class GetFavReagentsTests
    {
        ...
        public void Setup()
        {
            ...
            {
                new Reagent { Name = "Муравьиная кислота", Category = _categories[0], isFavourite = false},
                new Reagent { Name = "Этанол", Category = _categories[0], isFavourite = true},
                new Reagent { Name = "ДНК", Category = _categories[1], isFavourite = true}
            };
